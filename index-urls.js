...
async function run() {
  ...
  // Ensure this matches your actual sitemap URL
  const SITEMAP_URL = 'https://www.walzoo.com/sitemap-0.xml'; 
  ...
  try {
    ...
    if (!sites || sites.length === 0) {
      console.error('⚠️ No URLs found. Please check if your Sitemap URL is correct.');
      return;
    }
    ...
    console.log('✨ Success: All Walzoo content (Wallpapers & Blog) sent to Google!');
  } catch (err) {
