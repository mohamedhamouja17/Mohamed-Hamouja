...
const WallpaperCard: React.FC<WallpaperCardProps> = ({ wallpaper, showDownloadButton = true }) => {
  return (
    <div className="bg-white rounded-xl overflow-hidden shadow-lg transition-transform duration-300 ease-in-out hover:scale-105 flex flex-col">
      ...
      {showDownloadButton && (
        <div className="p-3">
          <button className="flex items-center justify-center gap-2 w-full bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold px-4 py-2 rounded-lg transition-colors text-sm">
